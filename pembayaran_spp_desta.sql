...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2025 at 12:04 PM
...
--
-- Database: `pembayaran_spp_desta`
--

-- --------------------------------------------------------

--
-- Table structure for table `db.spp`
--
...
--
ALTER TABLE `siswa`
  ADD CONSTRAINT `siswa_ibfk_1` FOREIGN KEY (`id_spp`) REFERENCES `db.spp` (`id_spp`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
